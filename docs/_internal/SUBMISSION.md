...
- GitHub repo: https://github.com/kohkoh099-boop/omnidub
- Live landing page + embedded demo video: https://kohkoh099-boop.github.io/omnidub/
- Architecture doc: https://github.com/kohkoh099-boop/omnidub/blob/main/docs/_internal/ARCHITECTURE.md
- One-click install: `docker compose up --build`
- Verified end-to-end: 2-speaker English source → 中文 dub generated by the real pipeline in 160 seconds on the Token Plan SGP endpoint (see `samples/` in the repo for source + dubbed output).
